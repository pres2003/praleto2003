...
//Функция нахождения несгенерированых чисел из диапозона 100...999 и занесение их в другой масив
//А[] - параметр функции, принимает массив чисел(целых).
//АА[] - параметр функции, принимает массив чисел(целых).
//Функция возвращает целое число(количество элементов второго массива для вывода
