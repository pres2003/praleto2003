...
int main()
{
	...
	*/
	...
	printf("\nЯкщо функцiя повернула не 0, то програма виконана некоректно, в iншому випадку все нормально виконано.");
	r = 0;
	// Цикл проверяет чтобы не один элемент двух массивов не совпадал
	while (r<N)
	{
		y = 0;
		while (y < u) 
	...
	t = 100;
	//цикл проверяет чтобы каждое число из диапозона 100 ... 999 было хотя бы в одном из массивов
	while (t <= 999)
	{
		er = 0;
		r = 0;
